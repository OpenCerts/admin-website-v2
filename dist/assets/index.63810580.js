...
`,h=({className:a,custom:s,placeHolder:l,onChange:n,value:r,dataTestId:c})=>t.createElement(E,null,t.createElement("input",{className:`${e(s)} ${a} `,placeholder:l,onChange:({target:e})=>n(""===e.value?"":e.value),value:r,"data-testid":c})),N=e`
